...
while (true)
{
    ...
    Console.WriteLine("6. Cartesian Explosion Demo");
    Console.WriteLine("7. Split Query Demo");
...
static void CartesianExplosionDemo()
{
    ...
    Console.WriteLine();
    Console.WriteLine("CARTESIAN EXPLOSION OBSERVED:");
    Console.WriteLine("- Single SQL query executed");
    Console.WriteLine("- Row duplication occurs (Diagnoses × Claims)");
    Console.WriteLine("- Profiler will show HIGH row count");
...
static void SplitQueryDemo()
{
    ...
    Console.WriteLine();
    Console.WriteLine("SPLIT QUERY DEMO (FIX)");
    Console.WriteLine("----------------------------");
    ...
    Console.WriteLine();
    Console.WriteLine("SPLIT QUERY BEHAVIOR:");
    Console.WriteLine("- Multiple SQL queries");
    Console.WriteLine("- NO duplication");
    Console.WriteLine("- Efficient loading");
