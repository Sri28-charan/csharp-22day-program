...
namespace PatientRegistryConsole
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                DisplayMenu();
                string choice = Console.ReadLine()?.Trim();//removing spaces
        ...
        static void DisplayMenu()
        {
            ...
            Console.WriteLine("7.Display previous updates");
        ...
        static void UpdatePatient()
        {
            ...
            history.Add($"{oldName}' updated to this → '{newName}'");
        }
        ...
        static void DisplayHistory()
        {
            if (history.Count==0)
            {
                Console.WriteLine("there is no update ");
            }
            else {
                foreach (string p in history)
                {
